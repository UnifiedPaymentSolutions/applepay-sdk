...
Apple Pay wrapper for Everypay users.
  ...
  s.homepage         = 'https://github.com/UnifiedPaymentSolutions/applepay-sdk'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mart Saarmets' => 'mart.saarmets@datanor.ee' }
  s.source           = { :git => 'https://github.com/UnifiedPaymentSolutions/applepay-sdk.git', :tag => s.version.to_s }
